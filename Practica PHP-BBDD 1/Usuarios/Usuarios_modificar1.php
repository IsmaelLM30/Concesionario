...
<body>
    ...
    <?php
        ...
        $instruccion = "select * from usuarios where nombre ='$nombre' or apellidos = '$apellido' or password = '$contraseña' or saldo = '$saldo' or dni = '$dni'";
        $consulta = mysqli_query ($host,$instruccion)
         or die ("Fallo en la consulta");
         $nfilas = mysqli_num_rows ($consulta);
         if ($nfilas > 0)
         {
            print("<form action='Usuarios_modificar2.php'>");
